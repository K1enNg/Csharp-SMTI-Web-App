...
namespace FinalExam3.Controllers
{
    public class CoursesController : Controller
    {
        ...
        public CoursesController(FinalExam3Context context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("CourseNumber,CourseTitle,TotalHour")] Course course)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(string id, [Bind("CourseNumber,CourseTitle,TotalHour")] Course course)
        {
